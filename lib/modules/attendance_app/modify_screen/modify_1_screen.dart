...
class ModifyScreen1 extends StatefulWidget {

  @override
  _ModifyScreen1State createState() => _ModifyScreen1State();
}

class _ModifyScreen1State extends State<ModifyScreen1> {
            ...
            children: [
              ...
              Expanded(
                child: defaultButton(
                  function: ()
                  {
                    navigateTo(context, ModifyScreen());
                  },
                  radius: 20,
                  width: 200,
                  text: 'Modify',
