    ...
    return BlocConsumer <ShopCubit , ShopStates>(
      ...
      builder: (context , state)
      {
        return ListView.separated(
          ...
          itemBuilder: (context , index) => buildCatItem(ShopCubit.get(context).categoriesModel.date.data[index]),
          separatorBuilder: (context , index) => myDivider(),
          itemCount: ShopCubit.get(context).categoriesModel.date.data.length,
        );
      },
    );
  }
